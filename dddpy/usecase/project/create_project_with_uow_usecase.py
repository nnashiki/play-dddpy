...
class CreateProjectWithUoWUseCase(ABC):
    """CreateProjectUseCase with Unit of Work support."""
...
class CreateProjectWithUoWUseCaseImpl(CreateProjectWithUoWUseCase):
...
def new_create_project_with_uow_usecase(
    uow: SqlAlchemyUnitOfWork,
) -> CreateProjectWithUoWUseCase:
    """Create a new instance of CreateProjectWithUoWUseCase."""
    return CreateProjectWithUoWUseCaseImpl(uow)
